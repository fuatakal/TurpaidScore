...
def main():
    ...
    st.markdown("<h1 style='text-align: center; color: black;'>TURPAIDx Score for Predicting Colchicine Resistant Disease Course in FMF Patients</h1>", unsafe_allow_html=True)
    ...
    if computed:
        ...
        st.markdown("""
            #### Score: <span style="color:black">{}</span>    
